...
export default function SettingsCard(){
    ...
    const {errors,handleSubmit,isPending,onSubmit,register} = UseEditProject()
    ...
    return(
        ...
        <div className="grid gap-3 mt-3">
            ...
            <Button disabled={isPending} type="submit" className="mt-3">{isPending?<Spinner/>:"Save Changes"}</Button>
        </form>
        </div>
    )
}