        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
          <div className="dark:bg-gray-950 bg-gray-150 shadow-xl p-10 rounded-xl">
            ...
            <form onSubmit={onSubmit} className="flex flex-col w-[350px] gap-5 mb-2">
              ...
              <p className="text-center mt-1 mb-3">Sign in to your account to continue</p>
              </div>
...
{isPending ? <Spinner /> : "Login"}      
    ...
    <p>Don't have an account? <Link className="text-blue-800" href="/register">Register</Link></p>
          </div>
        </div>
    )
}